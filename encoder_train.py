...
class Training:
    ...
    def run_epochs(self, transaction_encoder, customer_encoder, decoder, print_every=1000, learning_rate=0.01):
        ...
        train_loader = DataLoader(train_dataset, batch_size=self.config['BATCH_SIZE'], shuffle=True, num_workers=32)
        valid_loader = DataLoader(valid_dataset, batch_size=self.config['BATCH_SIZE'], shuffle=False, num_workers=32) 
